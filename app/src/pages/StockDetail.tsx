...
export default function StockDetailPage() {
  ...
  const { latestQuote, latestTrade } = useRealtimeMarketData(selectedSymbol);
  ...
  return (
    <main className="p-4 shadow-sm sm:p-5">
      <section className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_390px] xl:items-start">
        <BarsChart bars={bars} symbol={selectedSymbol} loading={barsLoading} error={barsError} range={range} onRangeChange={handleRangeChange} />
